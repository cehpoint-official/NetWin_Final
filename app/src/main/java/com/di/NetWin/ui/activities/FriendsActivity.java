...
public class FriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back=(ImageView)findViewById(R.id.backinfriends);
        ...
        ll=(LinearLayout)findViewById(R.id.friendsll);
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                if(TextUtils.equals(json.getString("profile_image"),"")||TextUtils.equals(json.getString("profile_image"),"null")){
                    ...
                    Picasso.get().load(json.getString("profile_image")).placeholder(R.drawable.alpha).fit().into(iv);
                }
