...
import com.di.NetWin.models.OrderData;
import com.di.NetWin.ui.activities.SingleOrderActivity;
...
public  class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OrderAdapter.MyViewHolder holder, int position) {
        ...
        if (!data.getpImage().equals("")) {
            Picasso.get().load(Uri.parse(data.getpImage())).placeholder(R.drawable.gamaa).fit().into(holder.iv);
        } else {
            holder.iv.setImageDrawable(mContext.getDrawable(R.drawable.gamaa));
        }
