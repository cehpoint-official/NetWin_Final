...
import com.di.NetWin.ui.activities.SingleProductActivity;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductAdapter.MyViewHolder holder, int position) {
        ...
        if (!data.getpImage().equals("")) {
            Picasso.get().load(Uri.parse(data.getpImage())).placeholder(R.drawable.gamaa).fit().into(holder.imageView);
        } else {

            holder.imageView.setImageDrawable(mContext.getDrawable(R.drawable.gamaa));
        }
