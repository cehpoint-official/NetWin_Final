...
import com.di.NetWin.ui.adapters.LudoMychallengelistAdapter;
        ...
        final JsonObjectRequest request = new JsonObjectRequest(url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            SharedPreferences sp=getActivity().getSharedPreferences("LUDO", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editor=sp.edit();
                            editor.putString("ludoname",response.getString("ludo_game_name"));
                            editor.apply();
                            Log.d("ludo name my contest",response.getString("ludo_game_name"));
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                Log.d("FIREBASE CHAT ID",json.toString());
